...
use Ixolit\Dislo\CDE\Form\Localization\CountryNameProvider;
...
class CountrySelector extends DropDownField {
	 ...
	 */
	public function getCountryNameProvider() {
	...
	private function rebuildLocalization() {
		if ($this->countryNameProvider) {
			$localizedValues = [];
			foreach ($this->getValues() as $countryCode => $countryName) {
				$newCountryName = $this->countryNameProvider->getCountryName($countryCode);
				if (!$newCountryName) {
					$newCountryName = $countryName;
				}
				$localizedValues[$countryCode] = $newCountryName;
			}
			parent::setValues($localizedValues);
		}
	}
