...
<div class="cdeToolbar small" id="cdeToolbar" style="display:none;">
	<a href="#cdeToolbar" class="cdeToolbarItem cdeToggleToolbar" id="cdeToggleToolbar"
	   title="Toggle Dislo CDE toolbar">
		<img
			alt="Dislo"
			height="40"
			width="47"
	...
	<a href="https://docs.dislo.com/display/DIS/Editing+website+content" class="cdeToolbarItem" target="_blank"
	   rel="noopener noreferrer" title="Read the CDE manual">
